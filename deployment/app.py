...
model_dir = 'model/model_group_mobile_04/ft10+5+4'
...
if selected_class != "None selected":
    ...
    with images_container.container():
        if selected_class == "Amphiprion_percula+Amphiprion_ocellaris":
            ...
            with col1:
                st.image(f'deploy/example_classes/{selected_classes[0]}/0.jpg', use_column_width=True)
            with col2:
                st.image(f'deploy/example_classes/{selected_classes[0]}/1.jpg', use_column_width=True)
            with col3:
                st.image(f'deploy/example_classes/{selected_classes[0]}/2.jpg', use_column_width=True)
        if selected_class == "Chelmon_rostratus":
            col1, col2, col3 = st.columns(3)
            with col1:
                st.image(f'deploy/example_classes/{selected_classes[1]}/0.jpg', use_column_width=True)
            with col2:
                st.image(f'deploy/example_classes/{selected_classes[1]}/1.jpg', use_column_width=True)
            with col3:
                st.image(f'deploy/example_classes/{selected_classes[1]}/2.jpg', use_column_width=True)
        if selected_class == "Nemateleotris_magnifica":
            col1, col2, col3 = st.columns(3)
            with col1:
                st.image(f'deploy/example_classes/{selected_classes[2]}/0.jpg', use_column_width=True)
            with col2:
                st.image(f'deploy/example_classes/{selected_classes[2]}/1.jpg', use_column_width=True)
            with col3:
                st.image(f'deploy/example_classes/{selected_classes[2]}/2.jpg', use_column_width=True)
        if selected_class == "Paracanthurus_hepatus":
            col1, col2, col3 = st.columns(3)
            with col1:
                st.image(f'deploy/example_classes/{selected_classes[3]}/0.jpg', use_column_width=True)
            with col2:
                st.image(f'deploy/example_classes/{selected_classes[3]}/1.jpg', use_column_width=True)
            with col3:
                st.image(f'deploy/example_classes/{selected_classes[3]}/2.jpg', use_column_width=True)
